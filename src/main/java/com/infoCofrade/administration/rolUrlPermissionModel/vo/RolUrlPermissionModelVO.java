package com.infoCofrade.administration.rolUrlPermissionModel.vo;

public class RolUrlPermissionModelVO implements Cloneable {
	private Long id;
	...
	public RolUrlPermissionModelVO() {
		this.id = null;
	...
	public Object clone() {
		RolUrlPermissionModelVO clone = new RolUrlPermissionModelVO();
		...
		if (this.getSelected() != null) {
			clone.setSelected(new Boolean(this.getSelected()));
		}
	...
	public boolean equals(Object obj) {
		...
		if (obj != null) {
			RolUrlPermissionModelVO rolUrlPermissionView = (RolUrlPermissionModelVO) obj;
			if ((rolUrlPermissionView.getId() != null && this.getId() != null && rolUrlPermissionView
					.getId() == this.getId())
					|| (rolUrlPermissionView.getIdUserType() != null
							&& this.getIdUserType() != null
							&& rolUrlPermissionView.getIdUserType().compareTo(
									this.getIdUserType()) == 0
							&& rolUrlPermissionView.getIdUrlPermission() != null
							&& this.getIdUrlPermission() != null && rolUrlPermissionView
							.getIdUrlPermission().compareTo(
									this.getIdUrlPermission()) == 0)) {
				result = true;
			}
		}
