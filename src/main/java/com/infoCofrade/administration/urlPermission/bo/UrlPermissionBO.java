package com.infoCofrade.administration.urlPermission.bo;
...
public interface UrlPermissionBO{
	...
	public Long createElement(Transaction transacion, UrlPermissionVO urlPermission) throws DaoException;
