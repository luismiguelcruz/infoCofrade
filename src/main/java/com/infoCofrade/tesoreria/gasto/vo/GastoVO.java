package com.infoCofrade.tesoreria.gasto.vo;

import com.infoCofrade.tesoreria.gasto.vo.GastoVO;

public class GastoVO implements Cloneable {
	private Long id;
	...
	public boolean equals(Object obj){
		...
		if(obj != null){
			GastoVO gasto = (GastoVO) obj;
			if((gasto.getId() == null && this.id == null) ||
					gasto.getId().compareTo(this.id) == 0){
				result = true;
			}
		}
